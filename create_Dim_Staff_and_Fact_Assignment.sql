...
CREATE TABLE Fact_Assignment (
    ...
    Major varchar(500) NULL,
    FileType varchar(500) NULL,
    IsTeachingAssignment TINYINT NOT NULL,
...
CREATE TABLE Dim_Staff (
    ...
    HighestDegree varchar(500) NULL,
    HighestDegreeYear SMALLINT NULL,
    AcademicCredits numeric(6,2) NULL,
    InServiceCredits numeric(6,2) NULL,
    ExcessCredits numeric(6,2) NULL,
    NonDegreeCredits numeric(6,2) NULL,
    ...
    StaffMixFactor1Sa varchar(500) NULL,
    StaffMixFactor1SB varchar(500) NULL,
    FTEHours numeric(6,2) NULL,
    FTEDays numeric(10,4) NULL,
    CertificatedFTE numeric(6,3) NULL,
    ClassifiedFTE numeric(6,3) NULL,
    CertificatedBase int NULL,
    ClassifiedBase int NULL,
    OtherSalary int NULL,
    TotalFinalSalary int NULL,
    ActualAnnualInsurance int NULL,
    ActualAnnualMandatory int NULL,
    CBRTNCode varchar(500) NULL,
    ClassificationFlag varchar(500) NULL,
    CertifiedFlag varchar(500) NULL,
    NationalBoardCertExpirationDate varchar(500) NULL,
    FileType varchar(500) NULL,
    IsTeacherFlag TINYINT NOT NULL,
    IsNoviceTeacherFlag TINYINT NOT NULL,
    IsPrincipalFlag TINYINT NOT NULL,
    IsAsstPrincipalFlag TINYINT NOT NULL,
    IsNationalBoardCertified TINYINT NOT NULL,
